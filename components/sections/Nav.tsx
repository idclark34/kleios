...
export function Nav({ onNotifyClick }: { onNotifyClick: () => void }) {
  return (
    <nav className="flex justify-between items-center relative z-[4]">
      ...
      <button
        ...
        className="bg-cream text-ink py-[9px] px-4 rounded-full font-sans font-semibold text-[11px] tracking-[1.5px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-ink focus-visible:outline-offset-2"
      >
        JOIN WAITLIST
      </button>
    </nav>
