  ...
  return (
    <nav className="flex justify-between items-center relative z-[4]">
      ...
      <div className="hidden md:flex gap-[22px] font-sans font-semibold text-[11px] tracking-[1.5px] opacity-90">
        ...
        <a href="#join" className="no-underline text-current focus-visible:outline focus-visible:outline-2 focus-visible:outline-cream focus-visible:outline-offset-2">GET IT</a>
      </div>
      <a
        href={APP_STORE_URL}
        target="_blank"
